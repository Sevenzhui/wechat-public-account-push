...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6ba3fae858f885c0',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '136959006917131d84a3b8f6cb01c628',
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '阴历', year: '2000', date: '06-12',
        },
        {
          type: '节日', name: '认识纪念日', year: '2022', date: '07-22',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '阳历', year: '2000', date: '07-13',
        },
        {
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'o_Hxg56tUK-L4YJxK6vRjp2vgV_M',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
